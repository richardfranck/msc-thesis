"""Training run: Gaussian model, airfoil deployment data.

Step 1: Search the encoder architecture and train a GaussianModel at the Gaussian
penalty pair, writing models/gaussian_airfoil, then fit NR_MEMBERS bootstrap
members at that frozen architecture, writing models/bootstrap_gaussian_airfoil.
...
the DGP implies, and real data has no DGP to reconstruct it from.
    ...
    python thesis/training/train_gaussian_airfoil.py
"""
