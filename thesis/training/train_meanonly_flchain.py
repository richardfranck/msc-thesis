"""Training run: MeanOnly model, flchain deployment data.

Step 1: Search the encoder architecture and train a MeanOnlyModel at the MeanOnly
roughness penalty, writing models/meanonly_flchain.
Step 2: Fit NR_MEMBERS bootstrap members at that frozen architecture, and write
to models/bootstrap_meanonly_flchain.

    python thesis/training/train_meanonly_flchain.py
"""
