"""Figure 7 (flchain): one individual, read by both model configurations.

Requires: meanonly_flchain, gaussian_flchain

    python thesis/thesis_figure_7_flchain.py
"""
...
# The individual both columns describe. Its random-effects summary reports an
# increasing state, which a monotone outcome cannot have.
INDEX = 380

OUTPUT_PATH = THESIS_DIR / "figures" / "thesis_figure_7_flchain.pdf"
...
HORIZON_LABEL = r"normalised follow-up time $t$"
...
OUTCOME_LABEL = "survival probability"
